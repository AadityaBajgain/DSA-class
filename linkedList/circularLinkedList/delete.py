...
class CircularLinkedList:
    ...
    def delete(self):
        ...
        if not self.head:
            return
        self.tail.next = None # to break the circular link (in python there is gc so it is optional but if there is no gc this is a must do step)
        self.head = None
        self.tail = None
        self.length = 0    
...
cir_linked_list.delete()
print(cir_linked_list)
print(cir_linked_list.tail.next)
print(cir_linked_list.length)